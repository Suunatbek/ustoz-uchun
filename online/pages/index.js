    ...
    return(
        <div>
          ...
          <div class="flex justify-between">
            <div class="flex" >
                <div class="ml-20">
                <div class="text-6xl font-extrabold">zeio</div>
                <div class="font-light text-2xl">Design</div>
                </div>
               <div class="flex mt-9 ml-8 gap-11 font-medium text-1xl">
            ...
            <div class="flex">
                <div class="mt-5 h-16 text-white flex justify-center text-center w-36 bg-black pt-5">$129 Buy Now</div>
                
                <div class="mt-8"> <img class=" h-8" src="qid.png" alt="" /></div>

               <div> <img class="h-14 mt-5 text-amber-400" src="https://media.istockphoto.com/id/1359210128/vector/shopping-cart-with-purchases-and-foods-icon-line-vector-illustration.jpg?s=612x612&w=0&k=20&c=N2hlzwOPMHjSaaBsy2a_EgqIXizrpH45yueojCzwb-w=" alt="" /></div>
            </div>
        </div>
        <div class="flex justify-center gap-20">
            <div>
                <div class="text-9xl font-light mt-52">A stylish UI Kit</div>
                <div class="mt-8 text-4xl font-medium">for all web creatives</div>
                <div class="mt-10 text-neutral-500 text-3xl">Zero is a Webflow Ecommerce and CMS UI kit including  <br /> several carefully designed page layouts.</div>
                <div class="flex mt-32 gap-14">
                <div>smooth <br />interactions</div>
                <div>
                many
                <br />
                page layouts
            ...
            <div>
            <img src="https://s3-alpha-sig.figma.com/img/34ca/5858/104d3f3828d19ac0097f352055a90ad3?Expires=1730073600&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=ffTR6iVy4mgY~LgUVGP6ovb~2XlQ6Zg4o1TnXA0KtDIf8vFxD9PzO1COkyjqoTamHEGk8HT7SH6X7xC7zaqrhCF7SNwOn6Iqnb4NqRQhaAGnlfOFUGXv54O9LnQcm5NxS-eJwrqmRwiaDiPK4-aqI9sgs6Il0-W1I8YNgXSHeyH5KDVukrkon3lZwH4yMjVeatkoiSMwMWbDz9EEYbgVFT2bfqtf9ubM8BKUeYG6UBMOit0hNtL0BIgaEPOFVr8fgwVc6ahO3-nUkLHibB-M2ecx5SN9N-ev5DSSbkIb3Dn43-c1-v~LyN491zw9c7GDPgf1F0Tcexhd5460l-VR2A__" alt="" />
            </div>
        </div>
        <div class="flex justify-center mt-40 gap-24">
            <div>
            <img class="h-[600px]" src="https://s3-alpha-sig.figma.com/img/d8db/3a59/27a610b5397829ded3a4b7716b5cacce?Expires=1730073600&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=lxB1xc2JCsUP6Vpv4RUVY2GZ~IDiNDVN40A2jVX9WxiINT3JvbjVd9r8iz8xHwNpuLQW3piqAw~kJW6-LqbVoYMT9fUuI-lShdfe7HR6QuZB4SXDQ~~dbaTFny51ShwuwuKSQCNceYkrDCriz7jDb74b-uX16xygpUUyKirdDrM3vhpc3uLhYDUUZ-WFnXkYmyXzugUaGahQ3U6xXaP0wXsRCpwiMAH4HrtMXvtbbcx3Nif2Uu3SCWZk8KdcS560TdmVhcRvjUKja-qKx6n2Veyzh~EfFmrVZ5WoyGCfxqi2yM0tUdEEO7ThfYMXcRvWCpXq4UMzxiNBUnprZ4K9Vg__" alt="" />
            </div>
            <div>
                <div class="text-9xl font-medium">Zero Design</div>
                <div class="mt-10  text-2xl">
                Includes a total of 10 static pages, divided like this: 4 Landing  <br />  pages, 2 About pages, 2 Contact page, 1 Team page, 1 FAQ  <br /> page. In addition to these, there are Webflow CMS driven pages  <br />: Blog (in 2 variations), Shop (in 2 variations), Works and Careers. <br /> All with their respective single pages!
                </div>
                <div>
                    <div class="flex mt-7 gap-7">
                        <div class=" h-12 text-white flex justify-center text-center w-32 bg-black pt-3">4 LANDING</div>
                        <div class=" h-12 text-white flex justify-center text-center w-32 bg-black pt-3">2 ABOUT</div>
                        <div class=" h-12 text-white flex justify-center text-center w-32 bg-black pt-3">3 CONTACT</div>
                       
                    </div>
                    <div class="flex mt-3  gap-7">
                    <div class=" h-12 text-white flex justify-center text-center w-32 bg-black pt-3">3 BLOG</div>
                    <div class="h-12 text-white flex justify-center text-center w-32 bg-black pt-3">2 SHOP</div>
                    </div>
                    <div class="flex mt-3  gap-7">
                    <div class=" h-12 text-white flex justify-center text-center w-32 bg-black pt-3">WORKS</div>
                    <div class=" h-12 text-white flex justify-center text-center w-32 bg-black pt-3">TEAM</div>
                    <div class=" h-12 text-white flex justify-center text-center w-32 bg-black pt-3">CAREERS</div>
                    </div>
                    <div class="flex mt-3   gap-7">
                    <div class=" h-12 text-white flex justify-center text-center w-32 bg-black pt-3">FORMS</div>
                    <div class=" h-12 text-white flex justify-center text-center w-32 bg-black pt-3">UTILITY</div>
                    </div>
                </div>
            </div>
        </div>
        <div class="ml-20 text-2xl mt-16 h-20 text-white flex justify-center text-center w-52 bg-black pt-6">LANDING PAGES</div>
        <div class="flex justify-center gap-24 mt-24">
            <div>
            <img class="h-[500px]" src="https://s3-alpha-sig.figma.com/img/5750/6861/c61f8cd14133e5a8592e477a6a4b3f65?Expires=1730073600&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=E8v6HDEiDGfkK5Wufu1RtYVBudb19UgESwskApe9i8k5USyz75OlO1F6vZ4CtNX~704InHVYvgW224H1iygMhl~6axkmaMo8dx1wYRzW1jDEbiGj1~IYQ10fM7~LmLiDS7o8mMsUc3AIlOn5L0sKsMveEj5YNkGW4HauVf~qEkSa0YV6SL0gzkJSUb9OgL7uMNqzJHr85nvxUx~0N0QojSU8~Ov5z0SesDRV~Os314Y3s17nX9F8O3QmYrNIH0g7mLCeZcOSm3gRqxDYBYfGYlRk7ewA6qvIVNI1E5IbpYqkedt7m1O~7fS-NHCDHqqQe-gi7lXXenkh09eJxY~6dg__" alt="" />
            <h1 class="text-3xl font-normal">Landing 1</h1>
            <br />
            <img class="h-[500px]" src="https://s3-alpha-sig.figma.com/img/b19f/046f/599ba940eed4379beb41c04576473edf?Expires=1730073600&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=mP49HkfJ3sukInwtEP1MCDm4VWW2GrYHshrl6GtmTsdsogDnIo7~yKHoP5y33YTcSpfuNU1mG61DMiC96pR7gvgFD06pSfeh8zBouUn0rnRzh0YK7orsj0p84BHbXGnsEmqmqGuoLNRQyM4kYy2n62skSjpKX37PnpJpPP~zy0K34mEL0fd8bmEdgON2Lp9t4wU5~zk70GON9V-hLxApFqiDuUlqL5j~55lvuSr3sTtMdmzkqy0R86EgA7wi5PPR1qMF84eZS-z1j6m0TsImM-o2DnoAbSsuLEK0vJxOmfZsqcGXTRkS2RIqaXarDW1YnrDit-x6R6Z4uFacFtxOCA__" alt="" />
            <h1  class="text-3xl font-normal">Landing 3</h1>
            </div>
            <div>
            <img class="h-[500px]" src="https://s3-alpha-sig.figma.com/img/3901/e9dc/d672478ef01bba9f115aedbd2c21363d?Expires=1730073600&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=GhkP6V89nLgqpdwrbcVsqHhzwUIwnNHdCcN9E5n~AEaTqPeOT1Ma7Rzwmscm9auLt8IvJGIm98s7GsFRpMMIuhPLcQMcNifrJMD8~zaDIJdKEqMovtbqUw4ARmsEi1v1bzi-Uy0lBvCGa6MD6Hn~ytH6DQeT~lGqdwAcJkD2kV6NM4TOTBQK4jxtW0hffKuvTuKJoUi5DJjHLSdjV-1Eg5V0oYV3vbE1~rHOLkwQYtf67giXiPR~VSdUBi33A3ogvAYgQz5RSozi0kO7UEgy~17HNYirYUGdszkuJUkg32twSaWimIoLVjZN9ep7VL-Ag8rSRo6py9qlFF91qOXgqQ__" alt="" />
            <h1  class="text-3xl font-normal">Landing 2</h1>
            <br />
